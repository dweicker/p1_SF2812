...
\section{Maximal additional flow}
\input{mod2.tex}
...
In the last one, we took into account that the capacities given could change and were stochastic parameters. We defined different scenarios and minimized the expected utility. It was of 86.15\% which is higher than in the deterministic model because of the uncertainty. It is easy to refine the solution by adding more scenarios.
